...
You will find detailed instructions concerning your tasks here: https://d067659.github.io/tpmc_documentation/evaluation/use_case_based_evaluation_process.html.
...
The time should be measured for each task individually, **excluding** the time for the login.
...
For this reason, please use the following activation key on prompt: **[ACTIVATION_KEY]**.

In order to map your results to your person, we suggest to stick to the following naming convention for the username: evaluation-[yourfirstname].

For task 5 (Create API) you are asked to provide header data for the API. Please specify the two key-value pairs 
[KEY]:[VALUE] and [KEY]:[VALUE] 
as the header data.

If you are facing any technical issues or are unable to solve a task, even with the provided hints, do not hesitate to contact us via the Discord channel at any time.
